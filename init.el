...
(custom-set-variables
 ...
 '(package-selected-packages
   '(django-mode elpy monokai-alt-theme sublime-themes molokai-theme lsp-tailwindcss dap-mode lsp-mode diminish expand-region rainbow-delimiters company-irony company-c-headers flycheck-clang-analyzer rainbow-mode mark-multiple helm linum-relative swiper fancy-battery spaceline dashboard async zerodark-theme web-mode json-mode yasnippet which-key use-package treemacs-projectile treemacs-magit treemacs-icons-dired treemacs-evil switch-window spacemacs-theme protobuf-mode poetry plantuml-mode ox-reveal org-bullets ob-go ido-vertical-mode htmlize go-mode flycheck company-quickhelp company-jedi beacon)))
(custom-set-faces
